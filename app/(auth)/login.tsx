        ...
        <View style={styles.topArea}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <View style={[styles.inputBox, emailError ? styles.inputError : null]}>
              ...
              <TextInput
                ...
                onBlur={() => {
                  if (email.length > 0 && !email.endsWith(".ac.kr") && !email.endsWith(".edu")) {
              ...
              />
              {email.length > 0 && (
                <TouchableOpacity onPress={() => { setEmail(""); setEmailError(""); setError(""); }}>
          ...
          <View style={styles.inputWrapper}>
            ...
            <View style={[styles.inputBox, error && !password ? styles.inputError : null]}>
              ...
              {password.length > 0 && (
                <TouchableOpacity onPress={() => { setPassword(""); setError(""); }} style={{ marginLeft: 8 }}>
                  <Ionicons name="close-circle" size={18} color="#ccc" />
                </TouchableOpacity>
              )}
            </View>
            ...
            >
              {isValid ? (
                ...
                <View style={[styles.loginButton, styles.loginButtonInactive]}>
                  <Text style={[styles.loginButtonText, styles.loginButtonTextInactive]}>로그인</Text>
                </View>
              )}
            </TouchableOpacity>
          </View>

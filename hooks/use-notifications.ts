...
export function useNotifications(openNotificationAction: OpenNotificationAction | null = null) {
    useEffect(() => {
        ...
        // 포그라운드 메시지 핸들러
        const unsubscribeMessage = messaging().onMessage((remoteMessage: RemoteMessage) => {
        });
